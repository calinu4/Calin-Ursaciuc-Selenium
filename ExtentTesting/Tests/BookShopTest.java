...
public class BookShopTest {
	...
	public void verifyHomePageTitle() {
		...
		report = new ExtentReports("C:\\extent.html", true);
		// start the test
		...
		if (title.equals("Hive.co.uk - Books, eBooks, DVDs, Blu-ray, Stationery, Music CDs")) {
	...
	public void verifyShopFinderTitle() throws IOException {
		...
		if (finderTitle.equals("Bookshop Finder")) {
	...
	public void verifyFirstResultDetails() throws IOException {
		...
		if (firsttitle.equals("Giddy Goat Toys") && firstdistance.equals("4.65 miles")
				&& firstaddress.equals("2 Albert Hill Street, Didsbury")) {
